...
namespace FMClassLib
{
    ...
    public partial class Team
    {
        public static List<Team> FromJson(string json) => JsonConvert.DeserializeObject<List<Team>>(json, FMClassLib.Converter.Settings);
    }

    public static class Serialize
    {
        public static string ToJson(this List<Team> self) => JsonConvert.SerializeObject(self, FMClassLib.Converter.Settings);
    }
